...
if(UNIX AND EXISTS "debian/" AND NOT EXISTS "debian/changelog")
    find_program(DCH dch)
    if(DCH)
        execute_process(COMMAND ${DCH} --create --empty -v ${PROJECT_VERSION}-${PROJECT_RELEASE} --package ${PROJECT_ARCHIVE})
    endif()
endif()
